...
public class Order extends AggregateRoot<OrderId> {
    ...
    private final RestaurantId restauranId;
    ...
    private void validateItemsPrice() {
       Money orderItemTotal = items.stream().map(orderItem -> {
        ...
        }).reduce(Money.Zero,Money::add); //creo total de articulos de pedidos
    ...
    private Order(Builder builder) {
        ...
        restauranId = builder.restauranId;
    ...
    public RestaurantId getRestauranId() {
        return restauranId;
    }
